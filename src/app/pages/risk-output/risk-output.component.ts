...
@Component({
  selector: 'app-risk-output',
  templateUrl: './risk-output.component.html',
  styleUrls: ['./risk-output.component.css']
})
export class RiskOutputComponent implements OnInit, OnChanges {
  data: any;
  adding: any;
  page_id: string='7';
