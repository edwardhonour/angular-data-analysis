...
@Component({
  selector: 'app-excel-output',
  templateUrl: './excel-output.component.html',
  styleUrls: ['./excel-output.component.css']
})
export class ExcelOutputComponent implements OnInit, OnChanges {
  data: any;
  adding: any;
  page_id: string='5';
