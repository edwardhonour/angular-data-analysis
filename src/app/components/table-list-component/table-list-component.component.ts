...
@Component({
  ...
  templateUrl: './table-list-component.component.html',
  styleUrls: ['./table-list-component.component.css']
})
export class TableListComponentComponent implements OnInit, OnChanges {
